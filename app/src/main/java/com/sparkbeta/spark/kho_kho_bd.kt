...
class kho_kho_bd : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_kho_kho_bd)
    ...
    private fun submitData() {
        ...
        val ref = FirebaseDatabase.getInstance().getReference("kho_kho")
        val player1 = SaveData2(d1, name1)
        val player2 = SaveData2(d2, name2)
        val player3 = SaveData2(d3, name3)
        val player4 = SaveData2(d4, name4)
        val player5 = SaveData2(d5, name5)
        val player6 = SaveData2(d6, name6)
